 ...
 * (GenCodeChecksum:594b5268952b95bc2fe33a3c1687b74f)
 */
...
class CRM_OSDI_DAO_DonationSyncState extends CRM_Core_DAO {
  ...
  /**
   * Modification date and time of the local Contribution record as of the beginning of the last sync, in unix timestamp format
   *
   * @var int|string|null
   *   (SQL type: int unsigned)
   *   Note that values will be retrieved from the database as a string.
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'contribution_id' => [
          ...
          'import' => TRUE,
          'where' => 'civicrm_osdi_person_sync_state.contribution_id',
          'export' => TRUE,
          'table_name' => 'civicrm_osdi_person_sync_state',
          'entity' => 'DonationSyncState',
          'bao' => 'CRM_OSDI_DAO_DonationSyncState',
        ...
        'remote_donation_id' => [
          ...
          'import' => TRUE,
          'where' => 'civicrm_osdi_person_sync_state.remote_donation_id',
          'export' => TRUE,
          'default' => NULL,
          'table_name' => 'civicrm_osdi_person_sync_state',
          'entity' => 'DonationSyncState',
        ...
        'local_pre_sync_modified_time' => [
          ...
          'description' => E::ts('Modification date and time of the local Contribution record as of the beginning of the last sync, in unix timestamp format'),
          'import' => TRUE,
  ...
  public static function indices($localize = TRUE) {
    $indices = [
      ...
      'index_remote_donation_id' => [
        ...
        'localizable' => FALSE,
        'sig' => 'civicrm_osdi_person_sync_state::0::remote_donation_id',
      ],
    ];
