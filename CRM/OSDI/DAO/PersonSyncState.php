 ...
 *
 * Generated from osdi-client/xml/schema/CRM/OSDI/OsdiSyncState.xml
 * DO NOT EDIT.  Generated by CRM_Core_CodeGen
 * (GenCodeChecksum:5ef55979de7621ad70d7715ce256e24f)
 */
...
class CRM_OSDI_DAO_PersonSyncState extends CRM_Core_DAO {
  ...
  /**
   * Modification date and time of the remote person record as of the beginning of the last sync, in unix timestamp format
   *
   * @var int|string|null
   *   (SQL type: int unsigned)
   *   Note that values will be retrieved from the database as a string.
  ...
  /**
   * Modification date and time of the remote person record at the end of the last sync, in unix timestamp format
   *
   * @var int|string|null
   *   (SQL type: int unsigned)
   *   Note that values will be retrieved from the database as a string.
  ...
  /**
   * Modification date and time of the local contact record at the end of the last sync, in unix timestamp format
   *
   * @var int|string|null
   *   (SQL type: int unsigned)
   *   Note that values will be retrieved from the database as a string.
  ...
  /**
   * Date and time of the last sync, in unix timestamp format
   *
   * @var int|string|null
   *   (SQL type: int unsigned)
   *   Note that values will be retrieved from the database as a string.
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'title' => E::ts('ID'),
          'description' => E::ts('Unique OsdiSyncState ID'),
          'required' => TRUE,
          'import' => TRUE,
        ...
        'remote_pre_sync_modified_time' => [
          ...
          'description' => E::ts('Modification date and time of the remote person record as of the beginning of the last sync, in unix timestamp format'),
          'import' => TRUE,
        ...
        'remote_post_sync_modified_time' => [
          ...
          'description' => E::ts('Modification date and time of the remote person record at the end of the last sync, in unix timestamp format'),
          'import' => TRUE,
        ...
        'local_post_sync_modified_time' => [
          ...
          'description' => E::ts('Modification date and time of the local contact record at the end of the last sync, in unix timestamp format'),
          'import' => TRUE,
        ...
        'sync_time' => [
          ...
          'description' => E::ts('Date and time of the last sync, in unix timestamp format'),
          'import' => TRUE,
