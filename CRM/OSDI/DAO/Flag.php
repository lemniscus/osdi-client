 ...
 * (GenCodeChecksum:9d6447cf6df153c7b7975adce3fb1d9d)
 */
...
class CRM_OSDI_DAO_Flag extends CRM_Core_DAO {
  ...
  /**
   * When the flag was created or modified.
   *
   * @var string|null
   *   (SQL type: timestamp)
   *   Note that values will be retrieved from the database as a string.
  ...
  public static function getEntityTitle($plural = FALSE) {
    return $plural ? E::ts('OSDI Flags') : E::ts('OSDI Flag');
  }
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'modified_date' => [
          ...
          'description' => E::ts('When the flag was created or modified.'),
          'usage' => [
            'import' => FALSE,
            'export' => FALSE,
            'duplicate_matching' => FALSE,
