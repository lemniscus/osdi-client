 ...
 * (GenCodeChecksum:eae3f384dafa19eb0b9f13506602674d)
 */
use CRM_OSDI_ExtensionUtil as E;

/**
 * Database access object for the OsdiLog entity.
 */
class CRM_OSDI_DAO_OsdiLog extends CRM_Core_DAO {
  ...
  public static function getEntityTitle($plural = FALSE) {
    return $plural ? E::ts('Osdi Logs') : E::ts('Osdi Log');
  }
