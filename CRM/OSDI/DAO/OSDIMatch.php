 ...
 * (GenCodeChecksum:1dfc25cf9df5c03107ce97d96f27b898)
 */
...
class CRM_OSDI_DAO_OSDIMatch extends CRM_Core_DAO {
  ...
  public static function getEntityTitle($plural = FALSE) {
    return $plural ? E::ts('OSDIMatches') : E::ts('OSDIMatch');
  }
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'sync_profile_id' => [
          ...
          'import' => TRUE,
          'where' => 'civicrm_osdi_match.sync_profile_id',
          'export' => TRUE,
          'table_name' => 'civicrm_osdi_match',
          'entity' => 'OSDIMatch',
          'bao' => 'CRM_OSDI_DAO_OSDIMatch',
        ...
        'sync_origin' => [
          ...
          'localizable' => 0,
          'pseudoconstant' => [
            'callback' => 'CRM_OSDI_BAO_OSDIMatch::syncOriginPseudoConstant',
          ],
          'add' => NULL,
        ],
        'sync_status' => [
          ...
          'size' => CRM_Utils_Type::HUGE,
          'import' => TRUE,
          'where' => 'civicrm_osdi_match.sync_status',
          'export' => TRUE,
          'default' => 'NULL',
          'table_name' => 'civicrm_osdi_match',
          'entity' => 'OSDIMatch',
  ...
  public static function indices($localize = TRUE) {
    $indices = [
      ...
      'index_sync_profile_id' => [
        ...
        'localizable' => FALSE,
        'sig' => 'civicrm_osdi_match::0::sync_profile_id',
      ],
      ...
      'index_sync_status' => [
        ...
        'localizable' => FALSE,
        'sig' => 'civicrm_osdi_match::0::sync_status',
      ],
    ];
