...
use Civi\Osdi\ActionNetwork\Syncer\Tagging as TaggingSyncer;
use CRM_OSDI_Fixture_PersonMatching as PersonMatchFixture;

/**
 * @group headless
 */
class CRM_OSDI_ActionNetwork_TaggingSyncerTest extends PHPUnit\Framework\TestCase implements
