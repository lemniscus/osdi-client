 ...
 * @group headless
 */
class CRM_OSDI_PersonMatchingTest extends \PHPUnit\Framework\TestCase implements HeadlessInterface, HookInterface,
                                                                                 TransactionalInterface
{
    ...
    {
        $contactId = \Civi\Api4\Contact::create()->addValue('contact_type', 'Individual')->addValue(
                'first_name',
                'Shangela'
            )->addValue('last_name', 'Wadley')->addChain(
                'contactEmail',
        ...
        \Civi\Api4\OsdiMatch::create()->addValue('contact_id', $contactId)->addValue(
            ...
            )->addValue('remote_system_id', $remoteSystemId)->execute();
    }
