 ...
 * @group headless
 */
class CRM_OSDI_Generic_OsdiPersonTest extends \PHPUnit\Framework\TestCase implements HeadlessInterface, HookInterface,
                                                                                     TransactionalInterface
{
    ...
    {
        $person = $this->makeExistingOsdiPerson();
        $personClass = get_class($person); // allow for child test classes
